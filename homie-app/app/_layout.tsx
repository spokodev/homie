  ...
  return (
    <>
      ...
      >
        ...
        />
        <Stack.Screen
          name="(modals)/household-settings"
          options={{
            presentation: 'modal',
            animation: 'slide_from_bottom',
          }}
        />
        <Stack.Screen
          name="(modals)/manage-invitations"
          options={{
            presentation: 'modal',
            animation: 'slide_from_bottom',
          }}
